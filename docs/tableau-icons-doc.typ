...
1. Download Release v#tableau-icons.tabler-icons-version from #text(blue, underline(link("https://github.com/tabler/tabler-icons/releases")))
2. Unzip the downloaded Zip-file
3. Go to `/webfonts/fonts`
4. Install one of the `tabler-icons.ttf` fonts (`tabler-icons.ttf`, `tabler-icons-200.ttf`, `tabler-icons-300.ttf`)
